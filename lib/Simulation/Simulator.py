...
class Simulator:
    ...
    """
    def __init__(self, osmMap, jobCSVPath, businessCVSPath, agentNum = 1000, threadNumber = 4, infectedAgent = 5, vaccinationPercentage = 0.0, reportPath="report", reportInterval=10, infectionModel = None, seed = 1000):
        """
        [Constructor]
        ...
        if (self.lastHour != hour):
            ...
            if self.threadNumber>1:
                ...
                for chunkOfAgent in self.agentChunks:
                    ...
                    thread = StepThread(f"Thread {i}",chunkOfAgent,self.timeStamp,returnDict,activitiesDict,self.businessDict, self.rng.integers(0,100000))
                ...
                nothread = StepThread(f"Nothread",chunkOfAgent,self.stepCount,returnDict,activitiesDict,self.businessDict, self.rng.integers(0,100000))
